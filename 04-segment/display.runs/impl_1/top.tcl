...
namespace eval ::optrace {
  variable script "V:/digital-electronics-1/04-segment/display/display.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet V:/digital-electronics-1/04-segment/display/display.runs/synth_1/top.dcp
